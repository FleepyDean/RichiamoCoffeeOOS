    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-border-2 u-border-grey-75 u-container-style u-group u-radius-39 u-shape-round u-white u-group-1">
            ...
            <div class="u-form u-form-1">
              <form action="" method="POST"  enctype="multipart/form-data" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form">
              ...
              <div class="u-form-group u-form-phone u-label-flag u-label-none-flag u-form-group-1">
                  ...
                  <input type="text" pattern="[0-9]{0-11}"  value="<?php echo $phoneNum; ?>" id="phoneNum" name="phoneNum" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" disabled>
                </div>
                ...
                <div class="u-form-group u-label-flag u-label-none-flag u-form-group-1">
                  ...
                  <div class="u-align-center u-form-group u-form-submit u-label-top">
                      <button type="submit" name="edit" class="u-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-radius-21 u-btn-1">Save</button>
                  </div>
