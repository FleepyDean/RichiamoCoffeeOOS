...
if (isset($_POST["verify"])) {
    ...
    if ($otp != $otp2) {
        ...
        if (mysqli_query($con, $mysql)) { // Changed $con to $connect
            echo '<script>alert("Account verified. You May Now Change Your Password.");
            window.location.href="verificationpassword.php?phoneNum=' . $phoneNum . '";</script>';
              ...
              <form action="" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" method="POST">
                <div class="u-form-group u-label-flag u-label-none-flag u-form-group-1">
                  ...
                  <div class="u-align-center u-form-group u-form-submit u-label-top">
                      <button type="submit" name="verify" class="u-black u-border-none u-btn u-btn-round u-btn-submit u-button-style u-radius-21 u-btn-1">Continue</button>
                  </div>
