...
$result2 = mysqli_query($con, $cEmail) or die (mysqli_error());
...
if (mysqli_num_rows($result) > 0 || mysqli_num_rows($result2) > 0)
{
	...
	$mysql = "INSERT INTO customer(phoneNum, fName, lName, email, pwd, id) VALUES ('$phoneNum', '$fName', '$lName', '$email', '$pwd', 1)" ; 
