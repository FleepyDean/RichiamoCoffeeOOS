...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>editCustomerForm</title>
    <link rel="stylesheet" href="../css/RCOOS.css" media="screen">
<link rel="stylesheet" href="../css/editCustomerForm.css" media="screen">
    ...
    <meta property="og:title" content="editCustomerForm">
  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-8f24">
      ...
      <h1 class="u-text u-text-default u-text-1">Edit Customer</h1>
          ...
          <div class="u-form u-form-1">
            <form action="" method="POST"  enctype="multipart/form-data" >
              ...
              <div class="u-form-group u-form-name">
                ...
                <input type="text" name="fName" value="<?php echo $row1['fName']; ?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
              </div>
              <div class="u-form-group u-form-name">
                <label for="name-05ef" class="u-label">Last Name</label>
                <input type="text" name="lName" value="<?php echo $row1['lName']; ?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
              </div>
              <div class="u-form-email u-form-group">
                <label for="email-05ef" class="u-label">Email</label>
                <input type="email" name="email" value="<?php echo $row1['email']; ?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
              </div>
              <div class="u-align-center u-form-group u-form-submit">
                <input type="submit" name="edit" value="SAVE" class="u-border-none u-btn u-btn-round u-button-style u-blue-25 u-hover-blue-5 u-radius-10 u-btn-15">
                  <a href="customerList.php" class="u-border-none u-btn u-btn-round u-button-style u-grey-25 u-hover-grey-5 u-radius-10 u-btn-15" >Back</a>
              </div>
