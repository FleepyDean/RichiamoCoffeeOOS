  ...
  <body class="u-body u-xl-mode" data-lang="en">
    <section class="u-clearfix u-section-1" id="sec-3b29">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <a href="cancelledorders.php" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-light-2 u-palette-2-base u-radius-50 u-text-black u-btn-3">Cancelled Order</a>
        <a href='acceptedorders.php' class='u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-custom-color-5 u-radius-50 u-text-black u-btn-2'>Accepted Order</a>
        <div class="u-expanded-width u-table u-table-responsive u-table-1">
            ...
            if (mysqli_num_rows($result) > 0)
          {
            ...
            echo"<th class='u-border-1 u-border-black u-table-cell'>Accept</th>";
            echo"<th class='u-border-1 u-border-black u-table-cell'>Cancel</th>";
            echo"</tr>";
            echo"</thead>";
            ...
            echo"<td class='u-border-1 u-border-grey-30 u-table-cell'><a href='acceptprocess.php?orderId=".$row['orderId']."' class='u-border-none u-btn u-btn-round u-button-style u-custom-color-1 u-hover-custom-color-5 u-radius-50 u-text-black u-btn-2'>Accept</a></td>";
            echo"<td class='u-border-1 u-border-grey-30 u-table-cell'><a href='cancelprocess.php?orderId=".$row['orderId']."' class='u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-light-2 u-palette-2-base u-radius-50 u-text-black u-btn-3'>Cancel</a></td>";
            echo"</tr>";
            echo"</tbody>";
            $x++;
        }
        ...
        <a href="dashboard.php" class="u-border-none u-btn u-btn-round u-button-style u-grey-25 u-hover-grey-5 u-radius-50 u-btn-2">Back</a>
      </div>
    </section>
    <br><br>
